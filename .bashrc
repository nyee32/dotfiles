...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[0;32m\]\u\[\033[0;33m\]@\[\033[0;32m\]\h\[\033[00m\]:\[\033[0;36m\]\w\[\033[00m\]\$ '
else
...
#graphics stuff
export GLEW_DIR=~/lib/glew-1.13.0
export EIGEN3_INCLUDE_DIR=~/lib/eigen-3.2.8
export GLFW_DIR=~/lib/glfw-3.1.2
